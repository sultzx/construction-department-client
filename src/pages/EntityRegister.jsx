...
import { fetchEntityRegister, fetchRegister, selectIsAuth } from "../redux/slices/auth.js";
...
const EntityRegister = () => {
  ...
  const CategoryOption = [
    ...
    {
        value: '2',
        text: 'Құрылыс заттарын жеткізуші'
    }
  ]


  const handleCategoryChange = (event) => {
    switch (CategoryOption[event.target.value].text) {
      case "Мердігер":
        setCategory("contractor");
        break;
      case "Құрылыс заттарын жеткізуші":
        setCategory("store");
        break;
    }
  };
                  ...
                  <Card.Body className="card-body">
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)} method="post">
                      ...
                      <Form.Label>Заңды тұлға үшін</Form.Label>
                        <Form.Control
                          ...
                          {...register("name", {
                            ...
                            minLength: {
                              value: 2,
                              message: 'Атыңыз 2 және 60 символ арасында болуы керек'
                            },
                            maxLength: {
                              value: 60,
                              message: 'Атыңыз 2 және 60 символ арасында болуы керек'
                      ...
                      <Form.Select
                        ...
                        className="form-control-input form-control select-input"
                      >
